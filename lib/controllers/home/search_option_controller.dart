...
class SearchOptionController extends GetxController {
  ...
  void onInit() {
    ...
    checkOut.text = DateFormat(dateFormat)
  ...
  void onSelectDate() {
    ...
    checkIn.text = DateFormat(dateFormat)
        .format(dateController?.selectedRange!.startDate as DateTime);
    checkOut.text = DateFormat(dateFormat)
        .format(dateController?.selectedRange!.endDate as DateTime);
    update();
    Get.back();
  }
